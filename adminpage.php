...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    ...
    <form class="form-inline my-2 my-lg-0 right" method="post" action="adminpage.php" >
      <input class="form-control mr-sm-2" type="text" name="valueToSearch" placeholder="Enter details" aria-label="Search">
